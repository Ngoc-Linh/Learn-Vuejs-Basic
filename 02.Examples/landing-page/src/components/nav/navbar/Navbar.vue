...
import NavbarBrand from '@/components/nav/navbar/NavbarBrand.vue';
import NavbarLinks from '@/components/nav/navbar/NavbarLinks.vue';
import NavbarToggleButton from '@/components/nav/navbar/NavbarToggleButton.vue';
